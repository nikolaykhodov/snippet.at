...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snippet.url_keyword'
        db.add_column('snippet_snippet', 'url_keyword',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snippet.url_keyword'
        db.delete_column('snippet_snippet', 'url_keyword')
