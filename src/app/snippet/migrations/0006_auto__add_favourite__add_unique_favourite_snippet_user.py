...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('snippet_favourite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('snippet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['snippet.Snippet'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('snippet', ['Favourite'])

        # Adding unique constraint on 'Favourite', fields ['snippet', 'user']
        db.create_unique('snippet_favourite', ['snippet_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Favourite', fields ['snippet', 'user']
        db.delete_unique('snippet_favourite', ['snippet_id', 'user_id'])

        # Deleting model 'Favourite'
        db.delete_table('snippet_favourite')
    ...
    models = {
        ...
        'snippet.favourite': {
            'Meta': {'unique_together': "(('snippet', 'user'),)", 'object_name': 'Favourite'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'snippet.snippet': {
            ...
            'url_keyword': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024', 'db_index': 'True', 'blank': 'True'})
        },
        'snippet.tag': {
