...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'TagFollower'
        db.delete_table('snippet_tagfollower')
    ...
    def backwards(self, orm):
        # Adding model 'TagFollower'
        db.create_table('snippet_tagfollower', (
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['snippet.Tag'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('snippet', ['TagFollower'])
